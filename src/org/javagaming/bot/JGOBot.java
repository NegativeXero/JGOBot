...
public class JGOBot extends PircBot
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            System.err.println("Failed to join freenode. Exiting now.");
            e.printStackTrace();
        }
    ...
    {
        listeners.forEach(org.javagaming.bot.EventListener::onConnect);
    }

    //Event triggered when the bot disconnects
    public void onDisconnect()
    {
        listeners.forEach(org.javagaming.bot.EventListener::onDisconnect);
    }
